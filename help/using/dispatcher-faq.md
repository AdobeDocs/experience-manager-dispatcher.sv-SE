...
>[!NOTE]
>
>GET- eller HEAD-metoderna (för HTTP-rubriken) kan nås av Dispatcher. Mer information om cachelagring av svarshuvuden finns i avsnittet [Caching HTTP Response Headers](dispatcher-configuration.md#caching-http-response-headers).

### Kan jag implementera flera utskickare i en konfiguration?

Ja. I så fall måste du se till att båda utskickarna har direktåtkomst till AEM webbplats. En Dispatcher kan inte hantera förfrågningar från en annan Dispatcher.
